...
<div class="flex flex-col items-start gap-2 w-full">
	...
	<div class="relative flex items-center w-full">
		<input
			type="text"
			class="input-selected w-full min-h-[54px] pr-11 border border-[#D0DDD7] rounded-14 p-4 placeholder:text-[#98B3AB] text-[#47675B] outline-none ease-out duration-100"
